...
ALTER TABLE ONLY public.appserver_sub
    ADD CONSTRAINT appserver_sub_uk_appserver_owner UNIQUE (appserver_id, app_user_id);
...
ALTER TABLE ONLY public.appserver
    ADD CONSTRAINT fk_app_user FOREIGN KEY (app_user_id) REFERENCES public.app_user(id) ON DELETE CASCADE;
