...
CREATE TABLE public.appserver_permission (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
...
CREATE TABLE public.channel_permission (
    id uuid DEFAULT public.uuid_generate_v4() NOT NULL,
...
ALTER TABLE ONLY public.appserver_permission
    ADD CONSTRAINT appserver_permission_pkey PRIMARY KEY (id);

ALTER TABLE ONLY public.appserver_permission
    ADD CONSTRAINT appserver_permission_uk_appserver_appuser UNIQUE (appserver_id, appuser_id);
...
ALTER TABLE ONLY public.channel_permission
    ADD CONSTRAINT channel_permission_pkey PRIMARY KEY (id);

ALTER TABLE ONLY public.channel_permission
    ADD CONSTRAINT channel_permission_uk_channel_appserver_role UNIQUE (channel_id, appserver_role_id);
...
ALTER TABLE ONLY public.appserver_permission
    ADD CONSTRAINT appserver_permission_appserver_id_fkey FOREIGN KEY (appserver_id) REFERENCES public.appserver(id) ON DELETE CASCADE;

ALTER TABLE ONLY public.appserver_permission
    ADD CONSTRAINT appserver_permission_appuser_id_fkey FOREIGN KEY (appuser_id) REFERENCES public.appuser(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY public.channel_permission
    ADD CONSTRAINT channel_permission_appserver_role_id_fkey FOREIGN KEY (appserver_role_id) REFERENCES public.appserver_role(id) ON DELETE CASCADE;
